...
let
  ...
  macbookSpecificBinds = ''
    ...
    bind = , XF86KbdBrightnessDown, exec, brightnessctl --device='smc::kbd_backlight' set 20%-
    bind = , XF86KbdBrightnessUp, exec, brightnessctl --device='smc::kbd_backlight' set +20%
  '';
